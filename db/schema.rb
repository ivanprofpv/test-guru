...
ActiveRecord::Schema.define(version: 2022_10_03_104734) do
  ...
  create_table "test_passages", force: :cascade do |t|
    ...
    t.index ["test_passages_id"], name: "index_test_passages_on_test_passages_id"
  ...
  add_foreign_key "test_passages", "questions", column: "test_passages_id"
